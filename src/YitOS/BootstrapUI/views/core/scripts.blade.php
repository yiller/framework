  ...
  <script src="{{ asset('assets/global/plugins/bootstrap-summernote/lang/summernote-zh-CN.min.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('assets/global/plugins/angularjs/angular-summernote.min.js') }}" type="text/javascript"></script>
  ...
  <script src="{{ asset('assets/global/plugins/jquery.form.min.js') }}" type="text/javascript"></script>
